            ...
            _c("div", { staticClass: "form-group" }, [
              ...
              _c(
                ...
                _vm._l(_vm.attributes, function(attribute) {
                  return _c("option", { domProps: { value: attribute } }, [
...
"use strict";
__webpack_require__.r(__webpack_exports__);
!(function webpackMissingModule() { var e = new Error("Cannot find module 'vue-swal'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
Vue.component('product-attributes', __webpack_require__(/*! ./components/ProductAttributes */ "./resources/js/components/ProductAttributes.vue")["default"]); // const files = require.context('./', true, /\.vue$/i);
// files.keys().map(key => Vue.component(key.split('/').pop().split('.')[0], files(key).default));


Vue.use(!(function webpackMissingModule() { var e = new Error("Cannot find module 'vue-swal'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())); //Vue.component('example-component', require('./components/ExampleComponent.vue').default);
...
module.exports = __webpack_require__(/*! C:\server\www\laravel\ecommerce\eapp\resources\js\app.js */"./resources/js/app.js");
